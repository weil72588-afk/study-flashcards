...
function startSession(queue,opts){if(!queue.length){toast('现在没有需要复习的卡片');return}closeAllModals();session={queue:[...queue],history:[],index:0,flipped:false,...opts};$('#studyTitle').textContent=session.title;showScreen('studyScreen');renderStudy()}
